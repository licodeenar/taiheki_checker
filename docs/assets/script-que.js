const data = {
    ...
    '2種（上下:陰）': [
        ...
        '「任せる」「期待している」と言われると気が重くなる',
        '考えごとが頭の中でぐるぐると回りやすい',
        '歩くときや考えるとき、うつむき加減になりやすい'
    ],
    '3種（左右:陽）': [
        '体に丸みがあり、なで肩になりやすい',
        '肌のきめが細かく、肉づきがやわらかい',
        '丸顔・童顔で、実年齢より若く見られる',
        '写真や鏡で見ると、体が右に傾いていることが多い',
    ...
    '4種（左右:陰）': [
        '角ばった体型で、いかり肩になりやすい',
        '頬骨が張っている',
        '写真や鏡で見ると、体が左に傾いていることが多い',
        '穏やかでニコニコして見られることが多い',
        '感情を表に出さないが、内側に残しやすい',
        'うまくいかないと「自分のせい」と考えがちだ',
        'やりたいことより、やりたくないことのほうがはっきりしている',
        '人と会った後、一人で振り返る時間が必要だ',
        '大勢より少人数の集まりを好む',
        'ストレスが続くと食欲が落ち、胃腸に出やすい'
    ],
    '5種（前後:陽）': [
        '胸板が広く、逆三角形の体型をしている',
        'エラが張っている、四角い顔つきだ',
    ...
    '8種（ねじれ:陰）': [
        ...
        '本心では、人と比べてしまうほうだ',
        'つい逆のこと・反対のことを言ってしまう',
        '立っているとき、つい片足に体重を乗せた姿勢になる'
    ],
    '9種（開閉:陽）': [
        '小柄で筋肉質、引き締まった体つきをしている',
        '顔が小さく、キュッと引き締まった顔つきだ',
        '靴の内側がすり減る、内また気味だと言われる',
        '群れるより、自分のやり方を通したい',
